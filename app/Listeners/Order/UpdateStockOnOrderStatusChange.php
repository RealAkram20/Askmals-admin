...
class UpdateStockOnOrderStatusChange
{
    ...
    {
        // Only restock when the item is truly out of the customer's hands.
        // RETURNING_TO_STORE and DELIVERY_FAILED are intentionally excluded — the
        // physical inventory is still in transit (rider is carrying it). Stock is
        // restored when the seller confirms receipt and the item finalises to
        // CANCELLED, which IS in this allow-list.
