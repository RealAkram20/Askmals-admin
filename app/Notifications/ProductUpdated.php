...
class ProductUpdated extends Notification implements ShouldQueue
{
    ...
    {
        return [\App\Notifications\Channels\RoleAwareDatabaseChannel::class, 'mail'];
    }
    ...
    /**
     * Map the $sentTo constructor flag to a role_type.
     */
    protected function resolveRoleType(): NotificationRoleTypeEnum
    {
        return match ($this->sentTo) {
            'admin' => NotificationRoleTypeEnum::ADMIN,
            'seller' => NotificationRoleTypeEnum::SELLER,
            'delivery_boy', 'rider' => NotificationRoleTypeEnum::RIDER,
            default => NotificationRoleTypeEnum::CUSTOMER,
        };
    }
}
