...
enum SubscriptionPlanKeyEnum : string
{
    ...
    /**
     * Keys that represent binary feature toggles (not countable limits).
     */
    ...
    /**
     * Whether this key is a boolean toggle rather than a numeric limit.
     */
    public static function isBoolean(string $key): bool
    {
        return in_array($key, self::booleanKeys(), true);
    }
}
