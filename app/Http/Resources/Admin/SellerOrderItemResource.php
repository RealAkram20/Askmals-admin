        ...
        return [
            ...
            'orderItem' => $this->whenLoaded('orderItem', function() {
                return [
                    ...
                    'status_label' => formatOrderStatusLabel($this->orderItem->status),
                    'cancellation_reason' => $this->orderItem->cancellation_reason,
                    'delivery_fail_reason' => $this->orderItem->delivery_fail_reason,
