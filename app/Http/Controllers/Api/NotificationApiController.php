...
class NotificationApiController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $result = $this->notificationService->getUserNotifications($userId, $perPage, $this->roleType);
    ...
    {
        try {
            $count = $this->notificationService->getUnreadCount((int) auth()->id(), $this->roleType);
    ...
    public function markAsRead(string $id): JsonResponse
    {
        try {
            ...
            $notification = $this->notificationService
                ->queryForUser((int) auth()->id(), $this->roleType)
                ->findOrFail($id);
    ...
    {
        try {
            $this->notificationService->markAllAsRead((int) auth()->id(), $this->roleType);
