...
class BrandApiController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $query = $this->buildZoneAwareBrandQuery($request);
    ...
    /**
     * Build the base brand query depending on whether the request carries a location.
     *
     * With lat/lng we delegate to BrandService::availableInStoresQuery() — same
     * shape used by the admin Zone Preview, so any tweak applies in one place.
     * Without lat/lng we keep the unrestricted product count.
     */
    private function buildZoneAwareBrandQuery(Request $request): \Illuminate\Database\Eloquent\Builder
    {
        ...
        if ($useZoneFilter) {
            ...
            return $this->brandService->availableInStoresQuery($storeIds);
        }
