...
<div class="page-header d-print-none mt-0">
    <div class="container-xl navbar align-items-center py-2 px-2">
        <div
                ...
                <div class="btn-list">
                    ...
                    @if($canViewNotifications)
                        @php
                            ...
                            $headerData   = app(NotificationService::class)->getHeaderNotifications(
                                userId: $id,
                                sentTo: $sentTo
                            );
                    ...
                    <div class="nav-item dropdown d-flex">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                            ...
                            <a href="{{ route(request()->segment(1).'.logout') }}" class="dropdown-item js-panel-logout">
