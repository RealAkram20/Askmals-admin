...
@section('admin-content')
    ...
    <div class="page-body">
        <div class="row row-deck row-cards">
            @isset($banner)
                @include('partials._visibility-inspector', ['endpoint' => route('admin.banners.visibility', $banner->id)])
            @endisset
            <form class="form-submit"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label required">
                                        ...
                                        <x-form-info-tooltip :title="__('messages.banner_scope_type_info_message')" />
                                    </label>
                        ...
                        <hr>
                        @php
                            $bannerAllZones = $allZones ?? true;
                            $bannerSelectedZoneIds = $selectedZoneIds ?? [];
                        @endphp
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('labels.zone_availability') }}</label>
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="all_zones" id="bannerAllZones" value="1" {{ old('all_zones', $bannerAllZones) ? 'checked' : '' }}>
                                        <label class="form-check-label" for="bannerAllZones">{{ __('labels.available_in_all_zones') }}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3" id="bannerZonesField" style="{{ old('all_zones', $bannerAllZones) ? 'display: none;' : '' }}">
                                    <label class="form-label">{{ __('labels.zones') }}</label>
                                    <select class="form-select" name="zone_ids[]" id="bannerZones" multiple {{ old('all_zones', $bannerAllZones) ? 'disabled' : '' }}>
                                        @foreach($deliveryZones as $zone)
                                            <option value="{{ $zone->id }}" {{ in_array($zone->id, old('zone_ids', $bannerSelectedZoneIds)) ? 'selected' : '' }}>{{ $zone->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('zone_ids')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label required">
                                        {{ __('labels.type') }}
                                        <x-form-info-tooltip :title="__('messages.banner_type_info_message')" />
                                    </label>
                        ...
                        <div id="customField" class="row" style="display: none;">
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="form-label required">
                                        {{ __('labels.custom_url') }}
                                        <x-form-info-tooltip :title="__('messages.banner_custom_url_info_message')" />
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label required">
                                        {{ __('labels.position') }}
                                        <x-form-info-tooltip :title="__('messages.banner_position_info_message')" />
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label required">
                                        ...
                                        <x-form-info-tooltip :title="__('messages.banner_visibility_status_info_message')" />
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">
                                        ...
                                        <x-form-info-tooltip :title="__('messages.banner_display_order_info_message')" />
                                    </label>
                        ...
                        <hr>
                        <x-seo-fields :metadata="$banner->metadata ?? null"/>
                    </div>
