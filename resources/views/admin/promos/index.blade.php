                        ...
                        <div class="modal-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">
                                            {{ __('labels.discount_type') }}
                                            <x-form-info-tooltip :title="__('messages.promo_discount_type_info_message')" />
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">
                                            {{ __('labels.discount_amount_or_percent') }}
                                            <x-form-info-tooltip :title="__('messages.promo_discount_amount_info_message')" />
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label">
                                            {{ __('labels.max_discount_value') }}
                                            <x-form-info-tooltip :title="__('messages.promo_max_discount_value_info_message')" />
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">
                                            {{ __('labels.min_order_total') }}
                                            <x-form-info-tooltip :title="__('messages.promo_min_order_total_info_message')" />
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">
                                            {{ __('labels.promo_mode') }}
                                            <x-form-info-tooltip :title="__('messages.promo_mode_info_message')" />
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">
                                            {{ __('labels.max_total_usage') }}
                                            <x-form-info-tooltip :title="__('messages.promo_max_total_usage_info_message')" />
                                        </label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label required">
                                            {{ __('labels.max_usage_per_user') }}
                                            <x-form-info-tooltip :title="__('messages.promo_max_usage_per_user_info_message')" />
                                        </label>
