                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">
                                    {{ __('labels.price') }}
                                    <x-form-info-tooltip :title="__('messages.subscription_plan_price_info_message')" />
                                </label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label">
                                    {{ __('labels.duration_type') }}
                                    <x-form-info-tooltip :title="__('messages.subscription_plan_duration_type_info_message')" />
                                </label>
                            ...
                            <div class="col-md-6 mb-3" id="duration_days_wrap">
                                <label class="form-label">
                                    {{ __('labels.duration_days') }}
                                    <x-form-info-tooltip :title="__('messages.subscription_plan_duration_days_info_message')" />
                                </label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <label class="form-check form-switch form-switch-3">
                                        ...
                                        <span class="form-check-label">
                                            {{ __('labels.is_free') }}
                                            <x-form-info-tooltip :title="__('messages.subscription_plan_is_free_info_message')" />
                                        </span>
                                    </label>
                                    <label class="form-check form-switch form-switch-2">
                                        ...
                                        <span class="form-check-label">
                                            {{ __('labels.is_recommended') }}
                                            <x-form-info-tooltip :title="__('messages.subscription_plan_is_recommended_info_message')" />
                                        </span>
                                    </label>
                                    <label class="form-check form-switch form-switch-2">
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-label required">
                                    <span>{{ __('labels.plan_configurations') }}</span>
                                    <small> ({{__('labels.leave_empty_unlimited')}})</small>
                                    <x-form-info-tooltip :title="__('messages.subscription_plan_configurations_info_message')" />
                                </div>
                                    ...
                                    <table class="table mb-0">
                                        ...
                                        @foreach(SubscriptionPlanKeyEnum::values() as $key)
                                            <tr>
                                                ...
                                                <td>
                                                    @if(SubscriptionPlanKeyEnum::isBoolean($key))
                                                        <label class="form-check form-switch mb-0">
                                                            <input type="hidden" name="{{ $key . '_value' }}" value="0">
                                                            <input class="form-check-input" type="checkbox"
                                                                   name="{{ $key . '_value' }}" value="1"
                                                                   @checked(old($key . '_value', $limitMap[$key] ?? 0) == 1)>
