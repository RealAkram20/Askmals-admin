                ...
                <div class="modal-content">
                    ...
                    <form class="form-submit" method="POST" action="{{route('admin.featured-sections.store')}}"
                        ...
                        <div class="modal-body">
                            @include('partials._visibility-inspector')

                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="scope_type" class="form-label required">
                                            {{ __('labels.scope_type') }}
                                            <x-form-info-tooltip :title="__('messages.featured_section_scope_type_info_message')" />
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="edit_section_type" class="form-label required">
                                            {{ __('labels.section_type') }}
                                            <x-form-info-tooltip :title="__('messages.featured_section_type_info_message')" />
                                        </label>
                                ...
                                <div class="col-md-6" id="sortOrderField">
                                    <div class="mb-3">
                                        <label for="sort_order" class="form-label">
                                            {{ __('labels.sort_order') }}
                                            <x-form-info-tooltip :title="__('messages.sort_order_info_message')" />
                                        </label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="style" class="form-label required">
                                            {{ __('labels.style') }}
                                            <x-form-info-tooltip :title="__('messages.featured_section_style_info_message')" />
                                        </label>
                                ...
                                <div class="col-md-6" id="categoriesField">
                                    <div class="mb-3">
                                ...
                                <div class="col-md-6" id="productsField" style="display: none;">
                                    <div class="mb-3">
                                        <label for="products"
                                               class="form-label">{{ __('labels.products') }}</label>
                                        <select class="form-select" id="select-product" name="products[]"
                                                multiple>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="all_zones" id="featuredAllZones" value="1" checked>
                                            <label class="form-check-label" for="featuredAllZones">{{ __('labels.available_in_all_zones') }}</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6" id="featuredZonesField" style="display: none;">
                                    <div class="mb-3">
                                        <label for="featuredZones" class="form-label">{{ __('labels.zones') }}</label>
                                        <select class="form-select" id="featuredZones" name="zone_ids[]" multiple disabled>
                                            @foreach($deliveryZones as $zone)
                                                <option value="{{ $zone->id }}">{{ $zone->name }}</option>
                                            @endforeach
                                        </select>
...
@push('scripts')
    ...
    <script src="{{hyperAsset('assets/js/featured-section.js')}}" defer></script>
@endpush
