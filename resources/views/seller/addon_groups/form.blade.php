                ...
                <form id="addon-group-form" action="{{ $action }}" method="POST" class="form-submit" novalidate>
                    ...
                    <div class="card-body border-bottom">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label class="form-label required d-block">
                                    {{ __('labels.addon_selection_type') }}
                                    <x-form-info-tooltip :title="__('messages.addon_selection_type_info_message')" />
                                </label>
                                <div class="row g-2">
                            ...
                            <div class="col-md-3">
                                <label class="form-label" for="addon-sort-order">
