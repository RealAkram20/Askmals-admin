                                                ...
                                                <form class="form-submit" method="POST"
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label">
                                                            ...
                                                            <x-form-info-tooltip :title="__('messages.available_for_withdrawal_info_message')" />
                                                        </label>
                                                        <div
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label">
                                                            {{ __('labels.blocked_balance') }}
                                                            <x-form-info-tooltip :title="__('messages.blocked_balance_info_message')" />
                                                        </label>
                                                        <div
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label required">
                                                            {{ __('labels.withdrawal_amount') }}
                                                            <x-form-info-tooltip :title="__('messages.withdrawal_amount_info_message')" />
                                                        </label>
