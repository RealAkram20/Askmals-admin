                    ...
                    <div class="col-sm-2 d-none d-lg-block">
                        <div class="sticky-top">
                            ...
                            <nav class="nav nav-vertical nav-pills" id="pills">
                                ...
                                <a class="nav-link" href="#pills-seo">{{ __('labels.seo_information') }}</a>
                            </nav>
                        </div>
                    </div>
                                ...
                                <form
                                        ...
                                        <div class="card-body">
                                            <div class="mb-3">
                                                <label class="form-label required">
                                                    ...
                                                    <x-form-info-tooltip :title="__('messages.store_address_proof_info_message')" />
                                                </label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label required">
                                                    ...
                                                    <x-form-info-tooltip :title="__('messages.store_voided_check_info_message')" />
                                                </label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label required">
                                                    {{ __('labels.tax_name') }}
                                                    <x-form-info-tooltip :title="__('messages.store_tax_name_info_message')" />
                                                </label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label required">
                                                    {{ __('labels.tax_number') }}
                                                    <x-form-info-tooltip :title="__('messages.store_tax_number_info_message')" />
                                                </label>
                                    ...
                                    <div class="card mb-4" id="pills-bank">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label required">
                                                    {{ __('labels.bank_branch_code') }}
                                                    <x-form-info-tooltip :title="__('messages.store_bank_branch_code_info_message')" />
                                                </label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label required">
                                                    {{ __('labels.routing_number') }}
                                                    <x-form-info-tooltip :title="__('messages.store_routing_number_info_message')" />
                                                </label>
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label required">
                                                    ...
                                                    <x-form-info-tooltip :title="__('messages.store_bank_account_type_info_message')" />
                                                </label>
                                    ...
                                    <div class="card mb-4" id="pills-seo">
                                        <div class="card-header">
                                            <h4 class="card-title">{{ __('labels.seo_information') }}</h4>
                                        </div>
                                        <div class="card-body">
